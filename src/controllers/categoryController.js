...
async function create(req, res) {
    res.render('admin/category/create', {pageTitle: 'Create Category'}); // Cần truyền pageTitle để hiển thị tiêu đề trang
}

// Xử lý lưu thông tin category mới
async function store(req, res) {
    try {
        await categoryService.crateCategory(req.body);
...
// Xử lý xóa category
async funnction remove(req, res) {
